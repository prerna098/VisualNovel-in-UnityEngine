...
The goal of this project is to simulate a scalable story-based game system similar to commercial visual novels.
...
- Player choice-based story progression
- Scene management and transitions
- Character sprite management
- Interactive UI system
- Modular dialogue scripting
- Expandable architecture for future features

The system is designed to separate narrative content from gameplay logic, making it easy to expand and maintain.
...
```bash
git clone https://github.com/prerna098/VisualNovel-in-UnityEngine.git
